    ...
    public void sendOtpEmail(String toEmail, String otp) {
        ...
        try {
            ...
            String htmlContent = "<div style=\"font-family: 'Inter', sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e2e8f0; border-radius: 12px; background-color: #faf6ee; color: #1c1c1c;\">" +
                    ...
                    "  <p style=\"font-size: 16px; line-height: 1.5;\">Please verify your email address by using the 6-digit One-Time Password (OTP) below:</p>" +
                    ...
                    "  </div>" +
                    "  <p style=\"font-size: 14px; line-height: 1.5; color: #718096;\">This OTP is valid for 5 minutes and can only be used once.</p>" +
